...
for (let y = 0; y < size; y++) {
  for (let x = 0; x < size; x++) {
    ...
    const left = Math.hypot(x - 77, y - 132),
      right = Math.hypot(x - 179, y - 132);
    const glasses =
      (left > 33 && left < 45) ||
      (right > 33 && right < 45) ||
      (x > 117 && x < 140 && y > 121 && y < 132) ||
      (x > 21 && x < 36 && y > 110 && y < 122) ||
      (x > 220 && x < 237 && y > 110 && y < 122);
    const color = glasses ? [143, 226, 219] : [20, 53, 69];
